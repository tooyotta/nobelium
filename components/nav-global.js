 ...
 */
    return(
        <div>
            <header className='py-2 bg-gradient-to-r from-sky-200 to-fuchsia-200'>
                <nav>
                    <div className='grid md:grid-cols-8 grid-cols-6 gap-2 px-2 mx-auto mt-4 sm:mt-6 max-w-2xl lg:max-w-3xl xl:p-0'>
                        <div className='flex col-span-4 md:col-span-6'>
                            <Link href='/'>
                                <a>
                                    <h1 className='justify-center font-mono text-3xl font-semibold'>toyota.im</h1>
                                </a>
                            </Link >
                            <span className='p-2 text-base font-semibold text-gray-800'>
                                {asPath}
                            </span>
                        </div>
                        <div>
                            <Link href='/about'>
                                <a>
                                    <div className='text-lg sm:text-2xl font-bold'>about</div>
                                </a>
                            </Link>                            
                        </div>
                        <div>
                            <Link href='/' locale={locale === 'ja' ? 'en' : 'ja'}>
                                <a>
                                    <svg className='fill-black w-8 sm:w-10' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
